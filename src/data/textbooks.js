export const textbooks = [
  ...
  },
  {
    ...
    usedAt: [
      ...
      {
        name: "Boğaziçi",
        url: "https://registration.bogazici.edu.tr/scripts/instructor/coursedescriptions/2025-2026-1/CMPE42501.PDF",
        archive: "https://web.archive.org/web/20260516180701/https://registration.bogazici.edu.tr/scripts/instructor/coursedescriptions/2025-2026-1/CMPE42501.PDF",
      },
    ],
    courses: [
      "Derleyici Tasarımı",
  ...
  },
  {
    ...
    category: "Programlama Dilleri",
    usageCount: 1,
    url: "https://www.pearson.com/en-us/subject-catalog/p/concepts-of-programming-languages/P200000003361",
    openAccess: false,
    description: "Programlama dilleri tasarımı ve uygulamasının temel kavramlarını kapsayan köklü bir başvuru kitabı.",
    coverColor: "#1565C0",
    usedAt: [
      {
        name: "Boğaziçi",
  ...
  },
  {
    ...
    shortAuthors: "Abu-Mostafa et al.",
    edition: "1. Baskı",
    year: 2012,
    publisher: "AMLBook",
    isbn: "978-1600490064",
    ...
    openAccess: false,
    description: "Makine öğrenmesinin teorik temellerini ve pratik uygulamalarını dengeli bir şekilde ele alan, Caltech'in ünlü ML dersinden doğan kısa ve öz bir kaynak.",
    coverColor: "#2E7D32",
    usedAt: [
      {
        name: "Boğaziçi",
